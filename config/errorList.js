module.exports = {
	...
	email: {
		...
		verifyEmailActionDescription:
			"Tap the button below to confirm your email address. If you didn't create an account with Subtle, you can safely delete this email.",
	},
	file: {
	...
	users: {
		...
		noUserEmailFound: 'No user found with this Email! \n Please Sign Up!',
	},
	login: {
		loginSuccess:
			'Login successfull ! Welcome into the world of ease and innovation .',
		invalidToken: 'Please provide proper login token',
		logoutSuccess: 'Logout Successfull!',
		resetPassword: 'Reset Password',
		resetPasswordActionDescription:
